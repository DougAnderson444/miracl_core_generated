...
impl DF {
    ...
    /* this*=y mod p */
    pub fn modmul(&mut self, y: &DF, p: &DF, nd: &DF) {
        // SL and DL
    ...
    /* this*=y mod p */
    pub fn modsqr(&mut self, p: &DF, nd: &DF) {
        // SL and DL
    ...
    pub fn power(&mut self, e: isize, p: &DF) {
        // DL only
        let mut w = DF::new();
        let nd = p.invmod2m();
        let mut f = true;
